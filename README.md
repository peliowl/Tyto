...
- **有机体**：TCard（卡片容器）、TLayout 布局系统（Header / Footer / Sider / Content + 响应式断点）、TMenu 导航菜单（垂直/水平模式、多级子菜单弹出、折叠切换）
...
| 导航菜单 | `TMenu` / `TMenuItem` / `TMenuItemGroup` | 垂直/水平模式、多级子菜单弹出、折叠切换、路由感知 |
